...
% January (Winter) in Maharashtra 2023
%% Assumptions:
...
inputData = "LoadDataMahaWinter.csv";
...
title('Maharashtra Winter (January 2023)')
...
title('Maharashtra Winter: EV Power and SOC for Charger No.', num2str(test_charger_index), 'LineWidth', 1)
