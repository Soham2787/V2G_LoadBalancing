...
% April (Summer) in Maharashtra 2023
%% Assumptions:
...
inputData = "LoadDataMahaSummer.csv";
...
title('Maharashtra Summer (April 2023)')
...
nexttile
plot([initial_time; time], Pev_Mat(test_charger_index, :), 'LineWidth', 1)
title('Maharashtra Summer 2023: EV Power and SOC for Charger No.', num2str(test_charger_index))
